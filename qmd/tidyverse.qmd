...
To pass the object to a different argument in a function, you can use the `_` placeholder as shown in the examples* below:
...
ggplot2 offers many plotting possibilities. You can learn more [here](https://ggplot2-book.org).
